...
import com.example.zyfypt_no7_406ml.fragments.MyCArticleFragment;
import com.example.zyfypt_no7_406ml.fragments.MyCCaseFragment;
import com.example.zyfypt_no7_406ml.fragments.MyCVideoFragment;
...
public class MyCollectActivity extends AppCompatActivity {
    ...
    private void initFragmentList() {
        ...
        fragmentList.add(new MyCArticleFragment());
        fragmentList.add(new TwareFragment());
        fragmentList.add(new MyCVideoFragment());
        fragmentList.add(new MyCCaseFragment());
