...
import com.example.zyfypt_no7_406ml.activities.ViewProjectActivity;
...
public class CollectProjectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<CollectResult<Tcase>> list;//数据源
    private Context context;//上下文
    public CollectProjectAdapter(Context context, List<CollectResult<Tcase>> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CollectProjectAdapter.ViewHolder(v);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        CollectProjectAdapter.ViewHolder viewHolder = (CollectProjectAdapter.ViewHolder) holder;
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("projectid",tcase.getId());
