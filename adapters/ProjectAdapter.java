...
public class ProjectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
      ...
      ProjectAdapter.ViewHolder viewHolder = (ProjectAdapter.ViewHolder) holder;
        Picasso.with(context)//新版的Picasso方法改为get()
                .load(Common.IMAGEURL+project.getThumb())
                .placeholder(R.mipmap.ic_launcher)
                .into(viewHolder.imageView);
        viewHolder.tvtitle.setText(project.getName());
        viewHolder.tvauthor.setText(project.getAuthor());
        viewHolder.tvtime.setText(project.getUpdate_time());
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("resid",project.getId());
