...
public class Special_VideoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<Video> list;
    private Context context;

    public Special_VideoAdapter(List<Video> list, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Special_VideoAdapter.ViewHolder viewHolder = (Special_VideoAdapter.ViewHolder) holder;
