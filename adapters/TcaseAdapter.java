...
public class TcaseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private List<Tcase> list;//数据源
    private Context context;//上下文
    public TcaseAdapter(Context context, List<Tcase> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TcaseAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        Tcase tcase= list.get(position);
        if (tcase == null)  return;
        TcaseAdapter.ViewHolder viewHolder = (TcaseAdapter.ViewHolder) holder;
